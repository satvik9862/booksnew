...
app.get("/nonfiction",function(req,res){  
    ...
    erro=""
    Item.find({category:"nonfiction"}, function(err,foundUser){
        if(foundUser){
            console.log(foundUser);
            res.render("nonfiction.ejs", {invItemsBook:foundUser});
        }
    })
    //res.render("shop.ejs");
...
app.get("/textbook",function(req,res){  
    ...
    erro=""
    Item.find({category:"textbook"}, function(err,foundUser){
        if(foundUser){
            console.log(foundUser);
            res.render("textbook.ejs", {invItemsBook:foundUser});
        }
    })
    //res.render("shop.ejs");
...
app.get("/other",function(req,res){  
    ...
    Item.find({category:"Other"}, function(err,foundUser){
        if(foundUser){
            console.log(foundUser);
            res.render("other.ejs", {invItemsBook:foundUser});
        }
    })
    //res.render("shop.ejs");
...
app.post("/search", function(req, res){
    ...
    Item.find({name:{$regex: searchFeild}}).then(data=>{
        //res.send(data);
